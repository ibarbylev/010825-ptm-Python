...
| {var:10}   | Минимальная ширина 10 символов, пробелы слева по умолчанию                     | `f"{'hi':10}"`         | 'hi        ' |
| {var:>10}  | Выравнивание по правому краю, ширина 10                                        | `f"{'hi':>10}"`        | '        hi' |
| {var:<10}  | Выравнивание по левому краю, ширина 10                                         | `f"{'hi':<10}"`        | 'hi        ' |
| {var:^10}  | Выравнивание по центру, ширина 10                                              | `f"{'hi':^10}"`        | '    hi    ' |
